<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DossierUtilisateur.aspx.cs" Inherits="SGINUREP.Vue.ModifierUtilisateur" %>
...
<body class="m-0 p-0">
  ...
  <ul class="dropdown-menu shadow p-3 mb-5 rounded border border-info">
    <li><a class="dropdown-item text-light" href="Enregistreretudiant.aspx">Ajouter un etudiant</a></li>
     <li><a class="dropdown-item text-light " href="Modifieretudiant.aspx">Dossier etudiant</a></li>
...
<section class="order-form py-2 ">
    <div class="container">
        <h2 class="merriweather text-center bg-primary mb-4">Modifier utilisateur</h2>
...
<div class="col-md-4 col-sm">
              <div class="input-group mb-3">
                <label for="validationTooltip01" class="m-2">Etat utilisateur</label>
                      <asp:DropDownList ID="cmbetat" runat="server">
                      <asp:ListItem>Etat utilisateur</asp:ListItem>

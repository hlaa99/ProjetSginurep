<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SGINUREP.Vue.Login" %>
	...
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-left">
				...
				<button class="ghost btn btn-outline-primary"  id="signIn">Connectez-vous</button>
			</div>
			<div class="overlay-panel overlay-right">
				<h1>Bienvenue, Friend!</h1>
				<p>Enrez les informations necessaires pour vous connecter</p>
				<button class="ghost" id="signUp">Connectez-vous</button>
			</div>
		</div>
	</div>
</div>

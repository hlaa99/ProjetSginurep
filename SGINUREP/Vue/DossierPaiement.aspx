<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DossierPaiement.aspx.cs" Inherits="SGINUREP.Vue.DossierPaiement" %>
...
<li>
  ...
  <section class="home-section">
    ...
    <div class="auto-style1">
        <h2 class="merriweather text-center bg-primary mb-4">Modifier Paiement</h2>
        <form class="auto-style1" runat="server">
            <div class="row">
            <div class="col-md-6 col-sm">
            <div class="input-group mb-3">
                 <asp:TextBox ID="tre" placeholder="" runat="server"></asp:TextBox>
        ...
        <div class="col-md-6 col-sm">
               ...
               <label for="validationTooltip01" class="m-2">Code etudiant</label>
                  <asp:TextBox ID="tid" class="form-control" placeholder="code" runat="server"></asp:TextBox>
              </div>
                 </div>
               <div class="col-md-6 col-sm">
               <div class="input-group mb-3">

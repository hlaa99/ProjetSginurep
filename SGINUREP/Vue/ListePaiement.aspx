<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListePaiement.aspx.cs" Inherits="SGINUREP.Vue.ListePaiement" %>
...
<body class="m-0 p-0">
 ...
 <section class="order-form py-2 ">
    <div class="container">
        <h2 class="merriweather text-center bg-primary mb-4">Listes paiement</h2>
        <form class="auto-style1" runat="server">

            <div class="card-body">
              <asp:GridView ID="Listepaiement" runat="server" BackColor="Blue" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="#3333CC" GridLines="Vertical" CssClass="table table-bordered table-sm" OnSelectedIndexChanged="Listepaiement_SelectedIndexChanged">

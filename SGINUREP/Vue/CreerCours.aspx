<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreerCours.aspx.cs" Inherits="SGINUREP.Vue.CreerCous" %>
...
<li>
  ...
  <section class="home-section">
    ...
    <div class="container">
        <h2 class="merriweather text-center bg-primary mb-4">Creer cours</h2>
              ...
              <div class="input-group mb-3">
               <label for="validationTooltip01" class="m-2">Discipline</label>
                  <asp:DropDownList ID="cmboption" runat="server">
                      ...
                      <asp:ListItem>Sciences informatique</asp:ListItem>
                      <asp:ListItem>Techn.Informatique(DUT)</asp:ListItem>
                      <asp:ListItem>Programation</asp:ListItem>
                      <asp:ListItem>Informatique Bureautique</asp:ListItem>
                      <asp:ListItem>Depannage d'ordinateur</asp:ListItem>
                      <asp:ListItem>Reseaux</asp:ListItem>
                      <asp:ListItem>Infographie</asp:ListItem>
              ...
              <div class="input-group mb-3">
               <label for="validationTooltip01" class="m-2">Technique/Professionnelle</label>
                  <asp:DropDownList ID="cmbtec" runat="server">
                      <asp:ListItem>Aucun</asp:ListItem>
                      <asp:ListItem>Auto-ecole</asp:ListItem>
                      <asp:ListItem>Cosmetologie</asp:ListItem>
                      <asp:ListItem>Cuisine-pâtisserie</asp:ListItem>
                      <asp:ListItem>Décoration gateaux</asp:ListItem>
                      <asp:ListItem>Décor.Evènementielle</asp:ListItem>
...
<div class="col-md-6 col-sm">
              <div class="input-group mb-3">
               <label for="validationTooltip01" class="m-2">Nom cours</label>
                  <asp:TextBox ID="tnomc" class="form-control" placeholder="Nom cours" runat="server"></asp:TextBox> 
                  </div>
              </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListerParNom.aspx.cs" Inherits="SGINUREP.Vue.ListerParNom" %>
...
<body class="m-0 p-0">
 ...
 <div class="container">
        <h2 class="merriweather text-center bg-primary mb-4">Listes etudiant par nom</h2>
        <form class="auto-style1" runat="server">
            <div class="row">
              <div class="col-md-6 col-sm">
                <asp:TextBox ID="tre" runat="server" OnTextChanged="tre_TextChanged"></asp:TextBox>
                <asp:Button ID="btnrechercher" runat="server" class="btn btn-primary" Text="Rechercher par nom" OnClick="btnrechercher_Click1" />

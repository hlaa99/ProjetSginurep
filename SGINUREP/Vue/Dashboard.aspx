<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="SGINUREP.Vue.Dashboard" %>
 ...
 <li class="dropstart">
  ...
  <ul class="dropdown-menu shadow p-3 mb-5 rounded border border-info">
    ...
    <li><a class="dropdown-item text-light" href="ListesEtudiant.aspx">Liste etudiant</a></li>
      <li><a class="dropdown-item text-light" href="ListesParNom.aspx">Liste etudiant par nom</a></li>
     ...
     <li>
       <a href="#">
         ...
         <span class="links_name">Saisir note</span>
       </a>
       <span class="tooltip">Saisir note</span>
     </li>
            <li>
       <a href="#">
         <i class='bx bx-chat' ></i>
  ...
  <section class="home-section">
    <nav class="navbar navbar-expand-lg  bg-dark">
      ...
      <section>
          	...
          	<div class="row md-0 py-0">
					<div class="card my-2 border-0 rounded-0">
						<div class="row">
							
          <div class="col-8 md-0">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DossierEtudiant.aspx.cs" Inherits="SGINUREP.Vue.DossierEtudiant" %>
...
<section class="auto-style2">
    <div class="container">
        <h2 class="merriweather text-center bg-primary mb-4">Modifier un etudiant</h2>
        <form class="auto-style1" runat="server">
            <div class="row">
               <div class="col-md-6 col-sm">
            <div class="input-group mb-3">
                 <asp:TextBox ID="trecherche" placeholder="Rechercher un etudiant" runat="server"></asp:TextBox>
...
<br/>
              ...
              <div class="input-group mb-3">
                 <label for="validationTooltip01" class="m-2">Nom</label>
                  <asp:TextBox ID="tnom" class="form-control" placeholder="Votre nom" runat="server"></asp:TextBox>
              </div>
              </div>
            <div class="col-md-6 col-sm">
              <div class="input-group mb-3">
                 <label for="validationTooltip01" class="m-2">Prenom</label>
                  <asp:TextBox ID="tprenom" class="form-control" placeholder="Votre prenom" runat="server"></asp:TextBox>
              </div>
              </div>
                 <div class="col-md-6 col-sm">
              <div class="input-group mb-3">
...
<div class="col-md-6 col-sm">
              <div class="input-group mb-3">
                   <label for="validationTooltip01" class="m-2">Statut</label>
                   <asp:DropDownList ID="cmbstatut" runat="server">
                      <asp:ListItem>Actif</asp:ListItem>
                      <asp:ListItem>Inactif</asp:ListItem>
                  </asp:DropDownList>              
